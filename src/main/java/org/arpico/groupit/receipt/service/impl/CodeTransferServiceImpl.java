...
public class CodeTransferServiceImpl implements CodeTransferService{
	...
	public ResponseEntity<Object> saveCodeTransferPrp(SaveCodeTransferDto saveCodeTransferDto) throws Exception {
		...
		if(!codeTransferHelperDtos.isEmpty()) {
			codeTransferHelperDtos.forEach(ct ->{
	...
	public ResponseEntity<Object> saveCodeTransferPol(SaveCodeTransferDto saveCodeTransferDto) throws Exception {
		...
		if(!codeTransferHelperDtos.isEmpty()) {
			codeTransferHelperDtos.forEach(ct ->{
				...
				try {
					InProposalsModel inProposalsModel=inProposalCustomDao.getProposalFromPolnum(Integer.valueOf(ct.getPprNum()));
	...
	public ResponseEntity<Object> rejectCodeTransfer(String user, Integer codeTransferId, String remark) throws Exception {
		...
		if(codeTransferModel != null) {
			...
			if(codeTransferModel.getPolNum() != null && codeTransferModel.getPolNum() != "" && !codeTransferModel.getPolNum().isEmpty() ) {
				...
				inProposalsModel=inProposalCustomDao.getProposalFromPolnum(Integer.valueOf(codeTransferModel.getPolNum()));
			}else {
				
				inProposalsModel=inProposalCustomDao.getProposalFromPprnum(Integer.valueOf(codeTransferModel.getPprNum()));
			}
	...
	public ResponseEntity<Object> approveCodeTransfer(String user, Integer codeTransferId, String remark)
		...
		if(codeTransferModel != null) {
			...
			List<InPropLoadingModel> inPropLoadingModels=inPropLoadingCustomDao.getPropLoadingBuPprNumAndSeq(Integer.valueOf(inProposalsModel.getInProposalsModelPK().getPprnum()), inProposalsModel.getInProposalsModelPK().getPrpseq());
			...
			List<InPropAddBenefitModel> addBenefitModels=inPropAddBenefictCustomDao.getBenefByPprSeq(Integer.valueOf(inProposalsModel.getInProposalsModelPK().getPprnum()), inProposalsModel.getInProposalsModelPK().getPrpseq());
			...
			List<InPropFamDetailsModel> famDetailsModels=famDetailsCustomDao.getFamilyByPprNoAndSeqNo(Integer.valueOf(inProposalsModel.getInProposalsModelPK().getPprnum()), inProposalsModel.getInProposalsModelPK().getPrpseq());
			...
			List<InPropSchedulesModel> inPropSchedulesModels=propScheduleCustomDao.getScheduleBuPprNoAndSeqNo(Integer.valueOf(inProposalsModel.getInProposalsModelPK().getPprnum()), inProposalsModel.getInProposalsModelPK().getPrpseq());
			...
			List<InPropMedicalReqModel> inPropMedicalReqModels=inPropMedicalReqCustomDao.getMedicalReqByPprNoAndSeq(Integer.valueOf(inProposalsModel.getInProposalsModelPK().getPprnum()), inProposalsModel.getInProposalsModelPK().getPrpseq());
			...
			List<InPropSurrenderValsModel> inPropSurrenderValsModels=surrenderValCustomDao.getSurrenderValByInpprNoAndSeq(Integer.valueOf(inProposalsModel.getInProposalsModelPK().getPprnum()), inProposalsModel.getInProposalsModelPK().getPrpseq());
			...
			List<InPropNomDetailsModel> nomDetailsModels=propNomDetailsCustomDao.getNomByPprNoAndPprSeq(Integer.valueOf(inProposalsModel.getInProposalsModelPK().getPprnum()), inProposalsModel.getInProposalsModelPK().getPrpseq());
			...
			List<InPropPrePolsModel> propPrePolsModels=propPrePolsCustomDao.getPrePolByPprNoAndPprSeq(Integer.valueOf(inProposalsModel.getInProposalsModelPK().getPprnum()), inProposalsModel.getInProposalsModelPK().getPrpseq());
			...
			if(codeTransferModel.getPolNum() == null || codeTransferModel.getPolNum() == "" || codeTransferModel.getPolNum().isEmpty()) {
				...
				List<AgentMastModel> agentMastModels=inAgentMastDao.getAgentDetails(codeTransferModel.getNewAgentCode());
				
				if(agentMastModels != null) {
					List<InBillingTransactionsModel> billingTransactionsModels=inBillingTransactionsCustomDao.getTransactionsByPprnum(inProposalsModel.getInProposalsModelPK().getPprnum());
