...
public class DashboardServiceImpl implements DashboardService {
	...
	public String getDate(DashboardGridModel model, String type) {
	...
	public LastReceiptSummeryDto getLastReceipt(DashboardDetailsModel e) {
	...
	public String getDate(PayModeGridModel model, String type) {
		String date = "";
