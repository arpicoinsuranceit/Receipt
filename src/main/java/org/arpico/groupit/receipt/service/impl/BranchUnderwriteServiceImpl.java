		...
		if(inProposalsModel != null) {
			...
			if(propFamDetailsModels != null) {
				...
				propFamDetailsModels.forEach(fam -> {
					inPropMedicalReqModels.add(getAdditionalReq("children", "AD-"+adNumAge,"Additional Requirement", "Age Proof Child -" + fam.getInPropFamDetailsPK().getFmlnam(), newInProposalsModelPK.getPprnum(),
							newInProposalsModelPK.getPrpseq(), newInProposalsModelPK.getLoccod()));
					adNumAge++;
				});
			}
			...
			if(!propFamDetailsModels.isEmpty()) {
				propFamDetailsModels.forEach(fam -> {
					if(fam.getHbcapp() == "Y") {
						inPropMedicalReqModels.add(getAdditionalReq("children", "AD"+adNumHB, "Additional Requirement","HB Questionnire for Child - " + fam.getInPropFamDetailsPK().getFmlnam(), newInProposalsModelPK.getPprnum(),
								newInProposalsModelPK.getPrpseq(), newInProposalsModelPK.getLoccod()));
						adNumHB++;
					}
					
					if(fam.getCicapp() == "Y") {
						inPropMedicalReqModels.add(getAdditionalReq("children", "AD"+adNumCIC, "Additional Requirement","CIC Questionnire for Child -" + fam.getInPropFamDetailsPK().getFmlnam(), newInProposalsModelPK.getPprnum(),
								newInProposalsModelPK.getPrpseq(), newInProposalsModelPK.getLoccod()));
						adNumCIC++;
					}
				});
