...
public class MiscellaneousReceiptServiceImpl implements MiscellaneousReceiptService {
	...
	public ResponseEntity<Object> save(MiscellaneousReceiptInvDto dto, String token) throws Exception {
	 ...
	 ReceiptPrintDto getReceiptPrintDto(RmsDocTxnmModel docTxnmModel, List<RmsDocTxndModel> docTxndModels,
	 ...
	 RmsDocTxndModel getDocTxndModelInv(MiscellaneousReceiptInvDto dto, String user, String docNo, ExpenseDto e,
	 ...
	 RmsDocTxnmModel getRmsDocTxnmModelInv(MiscellaneousReceiptInvDto dto, String user, String docNo,
	...
	public ArrayList<RmsDocTxnmGridDto> getLast(String token) throws Exception {
	 ...
	 RmsDocTxnmGridDto getTxnmGridDto(RmsDocTxnmGridModel e) {
