...
public class AgnInqAgnListModel {
	...
	public String toString() {
		return "AgnInqAgnListModel [agncod=" + agncod + ", agnnam=" + agnnam + ", agnnic=" + agnnic + ", agnsta="
				+ agnsta + ", sliirg=" + sliirg + ", supvid=" + supvid + ", agndob=" + agndob + ", subdcd=" + subdcd
				+ ", agnrdt=" + agnrdt + "]";
	}
