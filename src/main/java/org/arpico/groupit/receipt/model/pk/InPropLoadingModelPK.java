...
@Embeddable
public class InPropLoadingModelPK implements Serializable{
	...
	public InPropLoadingModelPK() {}
	
	public InPropLoadingModelPK(String sbucod, String loccod, Integer pprnum, String ridcod, Integer prpseq) {
		this.sbucod = sbucod;
		this.loccod = loccod;
		this.pprnum = pprnum;
		this.ridcod = ridcod;
