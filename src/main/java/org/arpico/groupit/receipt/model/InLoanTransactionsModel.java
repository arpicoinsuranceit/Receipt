...
@Entity
@Table(name = "inloantransactions")
public class InLoanTransactionsModel {
	private InLoanTransactionsModelPK inLoanTransactionsModelPK;
	private String cscode;
	private Integer quonum;
	private String pprnum;
	private Integer polnum;
	private Integer fclnum;
	...
	public InLoanTransactionsModelPK getInLoanTransactionsModelPK() {
		return inLoanTransactionsModelPK;
	}

	public void setInLoanTransactionsModelPK(InLoanTransactionsModelPK inLoanTransactionsModelPK) {
		this.inLoanTransactionsModelPK = inLoanTransactionsModelPK;
	}
	...
	public String toString() {
		return "InLoanTransactionsModel [inLoanTransactionsModelPK=" + inLoanTransactionsModelPK + ", cscode=" + cscode
				+ ", quonum=" + quonum + ", pprnum=" + pprnum + ", polnum=" + polnum + ", fclnum=" + fclnum
				+ ", totprm=" + totprm + ", creaby=" + creaby + ", creadt=" + creadt + ", seqnum=" + seqnum
				+ ", paymod=" + paymod + ", remark=" + remark + ", amtwrd=" + amtwrd + ", lockin=" + lockin
				+ ", chqnum=" + chqnum + ", chqbnk=" + chqbnk + ", chqdat=" + chqdat + ", ccdnum=" + ccdnum
				+ ", bancod=" + bancod + ", advcod=" + advcod + ", ntitle=" + ntitle + ", ppdnam=" + ppdnam
				+ ", ppdad1=" + ppdad1 + ", ppdad2=" + ppdad2 + ", ppdad3=" + ppdad3 + ", rctsta=" + rctsta
				+ ", txndat=" + txndat + ", chqrel=" + chqrel + ", reldat=" + reldat + ", bilpik=" + bilpik
				+ ", bildat=" + bildat + ", compad=" + compad + "]";
	}
