...
@Embeddable
public class InPropFamDetailsModelPK implements Serializable{
	...
	public InPropFamDetailsModelPK() {}

	public InPropFamDetailsModelPK(String sbucod, String loccod, Integer pprnum, String fmlnam,
			Integer prpseq) {
		this.sbucod = sbucod;
		this.loccod = loccod;
		this.pprnum = pprnum;
