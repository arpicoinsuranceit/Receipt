...
public class ReceiptInquiryCustomDaoImpl implements ReceiptInquiryCustomDao {
	...
	public BankDetailsModel getBankDetails(String docCode, Integer docNum) throws Exception {
		return jdbcTemplate.queryForObject("select paymod,bancod,chqnum,chqbnk,txndat,totprm,rctsta,remark from intransactions where  sbucod='450' and doccod='"+docCode+"' and docnum="+docNum+" ; ",
